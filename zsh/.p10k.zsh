# Generated by Powerlevel10k configuration wizard on 2023-11-06 at 23:06 EET.
...
() {
  ...
  typeset -g POWERLEVEL9K_PER_DIRECTORY_HISTORY_GLOBAL_FOREGROUND=4
  ...
  typeset -g POWERLEVEL9K_NODE_VERSION_PROJECT_ONLY=faalse
  # Custom icon.
