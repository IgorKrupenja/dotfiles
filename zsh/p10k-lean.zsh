...
() {
  ...
  vcs+='%10F${${VCS_STATUS_LOCAL_BRANCH//\%/%%}:-%f@%10F${VCS_STATUS_COMMIT[1,8]}}'
  ...
  vcs+='${VCS_STATUS_ACTION:+ %000F${VCS_STATUS_ACTION//\%/%%}}'
  # ~42 if have merge conflicts.
  vcs+='${${VCS_STATUS_NUM_CONFLICTED:#0}:+ %000F~${VCS_STATUS_NUM_CONFLICTED}}'
